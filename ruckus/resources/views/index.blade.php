...
<head>
	...
	<link rel="shortcut icon" href="assets/media/logos/logruckus.png" class="h-40px" />
	<!--begin::Fonts-->
			...
			<div id="kt_aside" class="aside aside-extended bg-white" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
				...
				<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
					...
					<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">
						<a href="/index">
							<img alt="Logo" src="assets/media/logos/logruckus.png" class="h-50px" />
						</a>
					</div>
					<!--end::Logo-->
					<!--begin::Nav-->
					...
					<div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
						...
						<div class="d-flex align-items-center mb-2">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
								<!--begin::Heading-->
								<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('assets/media/misc/pattern-5.png')">
									<!--begin::Title-->
										...
										<div class="d-flex flex-column px-9">
											...
											<div class="pt-10 pb-0">
												...
												<div class="text-center mt-5 mb-9">
													<a href="#" class="btn btn-sm btn-primary px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">popup1</a>
												</div>
												<!--end::Action-->
											</div>
											<!--end::Section-->
						...
						<div class="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
								...
								<!--end::Menu item-->
								<!--begin::Menu item-->
								<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end" data-kt-menu-flip="bottom">
								...
								<div class="tab-content">
									...
									<div class="tab-pane fade active show" id="kt_aside_nav_tab_projects" role="tabpanel">
										...
										<div class="m-0">
											...
											<div class="m-0">
												<!--begin::Heading-->
												<h1 class="text-gray-800 fw-bold mb-6 mx-5">Inex001</h1>
												<!--end::Heading-->
												<!--begin::Items-->
												<div class="mb-10">
													<!--begin::Item-->
									...
									<div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
										...
										<div class="mx-5">
											...
											<div class="text-center pt-10 mb-20">
												...
												<!--end::Description-->
												<!--begin::Action-->
												<a href="#" class="btn btn-primary" data-bs-target="#kt_modal_upgrade_plan" data-bs-toggle="modal">popup2</a>
												<!--end::Action-->
											</div>
											<!--end::Container-->
											<!--begin::Illustration-->
										...
										<div class="mx-5">
											...
											<div class="mb-12">
												...
												<div class="d-flex align-items-center mb-7">
													...
													<!--begin::Text-->
													<div class="d-flex flex-column">
														<a href="pages/profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Project Briefing</a>
												...
												<div class="d-flex align-items-center mb-7">
													...
													<!--begin::Text-->
													<div class="d-flex flex-column">
														<a href="pages/profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Concept Design</a>
												...
												<div class="d-flex align-items-center mb-7">
													...
													<!--begin::Text-->
													<div class="d-flex flex-column">
														<a href="pages/profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Functional Logics</a>
												...
												<div class="d-flex align-items-center mb-7">
													...
													<!--begin::Text-->
													<div class="d-flex flex-column">
														<a href="pages/profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Development</a>
												...
												<div class="d-flex align-items-center mb-7">
													...
													<!--begin::Text-->
													<div class="d-flex flex-column">
														<a href="pages/profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">Testing</a>
												...
												<div class="d-flex align-items-center mb-7">
													...
													<!--begin::Text-->
													<div class="d-flex flex-column">
														<a href="pages/profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">HTML, CSS Coding</a>
														<span class="text-muted fw-bold">Art Director</span>
													</div>
													<!--end::Text-->
												</div>
												...
												<div class="d-flex align-items-center">
													...
													<!--begin::Text-->
													<div class="d-flex flex-column">
														<a href="pages/profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bold">ReactJS Developer</a>
											...
											<div class="mb-12">
												...
												<div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
													...
													<div class="flex-grow-1 me-2">
														<a href="widgets/lists.html" class="fw-bolder text-gray-800 text-hover-primary fs-6">Group lunch celebration</a>
												...
												<div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
													...
													<!--begin::Title-->
													<div class="flex-grow-1 me-2">
														<a href="widgets/lists.html" class="fw-bolder text-gray-800 text-hover-primary fs-6">Navigation optimization</a>
												...
												<div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
													...
													<!--begin::Title-->
													<div class="flex-grow-1 me-2">
														<a href="widgets/lists.html" class="fw-bolder text-gray-800 text-hover-primary fs-6">Humbert Bresnen</a>
												...
												<div class="d-flex align-items-center bg-light-info rounded p-5 mb-7">
													...
													<!--begin::Title-->
													<div class="flex-grow-1 me-2">
														<a href="widgets/lists.html" class="fw-bolder text-gray-800 text-hover-primary fs-6">Air B &amp; B - Real Estate</a>
												...
												<div class="d-flex align-items-center bg-light-primary rounded p-5 mb-7">
													...
													<!--begin::Title-->
													<div class="flex-grow-1 me-2">
														<a href="widgets/lists.html" class="fw-bolder text-gray-800 text-hover-primary fs-6">B &amp; Q - Food Company</a>
												...
												<div class="d-flex align-items-center bg-light-danger rounded p-5">
													...
													<!--begin::Title-->
													<div class="flex-grow-1 me-2">
														<a href="widgets/lists.html" class="fw-bolder text-gray-800 text-hover-primary fs-6">Nexa - Next generation</a>
				...
				<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
					...
					<div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
							<!--begin::Heading-->
							<h1 class="text-dark fw-bolder my-0 fs-2">Overview</h1>
							<!--end::Heading-->
							<!--begin::Breadcrumb-->
							<!-- แถบของOverview-->
						...
						<div class="d-flex d-lg-none align-items-center ms-n2 me-2">
							...
							<a href="index.html" class="d-flex align-items-center">
								<img alt="Logo" src="assets/media/logos/logo-demo-3.svg" class="h-30px" />
							</a>
							<!--end::Logo-->
						</div>
						<!--end::Wrapper-->
										...
										<div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
											...
											<div class="d-flex flex-column px-9">
												...
												<div class="pt-10 pb-0">
													...
													<!--begin::Action-->
													<div class="text-center mt-5 mb-9">
														<a href="#" class="btn btn-sm btn-primary px-6" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">popup3</a>
													</div>
													<!--end::Action-->
												</div>
												<!--end::Section-->
        ...
        <table class="table table-striped gy-7 gs-7" id="test">
            <thead>
                ...
                <!-- <th class="min-w-200px fs-3">#</th> -->
                    ...
                    <th class="min-w-200px fs-3">Hostname</th>
                    <th class="min-w-200px fs-3">OS Type</th>
                    <th class="min-w-200px fs-3">IP Address</th>
                    <th class="min-w-200px fs-3">MAC Address</th>
					<th class="min-w-200px fs-3">AP Name</th>
					<th class="min-w-200px fs-3">WLAN</th>
					<th class="min-w-200px fs-3">AP MAC</th>
					<th class="min-w-200px fs-3">Traffic (Session)</th>
					<th class="min-w-200px fs-3">RSSI</th>
					<th class="min-w-200px fs-3">SNR</th>
					<th class="min-w-200px fs-3">Radio Type</th>
					<th class="min-w-200px fs-3">VLAN</th>
					<th class="min-w-200px fs-3">Channel</th>
					<th class="min-w-200px fs-3">CPE MAC</th>
					<th class="min-w-200px fs-3">Session start time</th>
            ...
            <tbody>
                ...
                ?>
                    <tr class=" fs-5">
                        <td><?php echo ($arr['list'][$i]['hostname']) ?></td>
						<td><?php echo ($arr['list'][$i]['osType']) ?></td>
						<td><?php echo ($arr['list'][$i]['ipAddress']) ?></td>
						<td><?php echo ($arr['list'][$i]['clientMac']) ?></td>
						<td><?php echo ($arr['list'][$i]['apName']) ?></td>
						<td><?php echo ($arr['list'][$i]['ssid']) ?></td>
						<td><?php echo ($arr['list'][$i]['apMac']) ?></td>
						<td><?php echo ($arr['list'][$i]['traffic']) ?></td>
						<td><?php echo ($arr['list'][$i]['rssi'])." "."dBm" ?></td>
						<td><?php echo ($arr['list'][$i]['snr'])." "."dB" ?></td>
						<td><?php echo ($arr['list'][$i]['radioType']) ?></td>
						<td><?php echo ($arr['list'][$i]['vlan']) ?></td>
						<td><?php echo ($arr['list'][$i]['channel']) ?></td>
						<td><?php echo ($arr['list'][$i]['userName']) ?></td>
						
						<td><?php 
						if ($arr['list'][$i]['sessionStartTime'] == 0){
							echo"N/A";
						  }else if($arr['list'][$i]['sessionStartTime'] != 0){
							$srttime = $arr['list'][$i]['sessionStartTime'];
							$time = substr($srttime,0,-3);
                ...
                <?php endfor ?>
								...
								//print_r ($arr['list'][1]) ;
								//for ($i = 0; $i < count($arr['list']); $i++) {
									// echo ($arr['list'][$i]['hostname'] ." ".
									// 	$arr['list'][$i]['osType'] ." ".
									// 	$arr['list'][$i]['ipAddress'] ." ".
									// 	$arr['list'][$i]['clientMac'] ." ".
									// 	$arr['list'][$i]['apName'] ." ".
									// 	$arr['list'][$i]['ssid'] ." ".
									// 	$arr['list'][$i]['apMac'] ." ".
									// 	$arr['list'][$i]['traffic'] ." ".
									// 	$arr['list'][$i]['rssi'] ." ".
									// 	$arr['list'][$i]['snr'] ." ".
									// 	$arr['list'][$i]['radioType'] ." ".
									// 	$arr['list'][$i]['vlan'] ." ".
									// 	$arr['list'][$i]['channel'] ." ".
									// 	$arr['list'][$i]['userName'] ." ".
									// 	$arr['list'][$i]['sessionStartTime'] ." ".
								...
								//}
								?>
								osType ipAddress clientMac apName ssid apMac traffic rssi snr radioType vlan channel userName sessionStartTime
